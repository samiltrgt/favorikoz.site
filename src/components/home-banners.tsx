  ...
  return (
    <section className="container py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Right - Accent banner */}
        <Link href="/kategori/makyaj" className="group relative overflow-hidden rounded-3xl bg-accent text-accent-foreground p-8 min-h-[260px] flex flex-col justify-between transform-gpu animate-float animation-delay-400">
          {/* Background image */}
          <Image
          ...
          />
          <div className="relative z-10">
            <h3 className="text-2xl font-light tracking-tight">Makyajda Zarafet</h3>
